...
{
    const char     *desc[] = {
        "This tool compute filament properties as a quantity of time such as:",
        "[PAR]",
        "helical pitch",
        "[PAR]",
...
//      { efSTO, "-flmnt",      "flmnt",    ffWRITE },
//      { efSTO, "-mono1",      "mono1",    ffWRITE },
//      { efSTO, "-mono2",      "mono2",    ffWRITE },
    };
...
//  write_sto_conf(opt2fn("-mono1",NFILE,fnm),title,mono1->atoms,mono1->x,NULL,ePBC,box);
//  write_sto_conf(opt2fn("-mono2",NFILE,fnm),title,mono2->atoms,mono2->x,NULL,ePBC,box);
